...
ПРОЕКТ НАХОДИТЬСЯ В СТАДИИ РАЗРАБОТКИ! 
 ...
 При реализации проекта:
   ...
   - отправка данных с форм на сервер(раздел "Контакты", добавление статей в блог) происходит по AJAX (jQuery),
...
Проект в сети: 
 - клиентская часть 
   ...
   http://http://codeleo.3eeweb.com/
   
 - административная панель 
 
   http://codeleo.3eeweb.com/admin/
