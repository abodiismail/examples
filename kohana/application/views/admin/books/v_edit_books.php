...
<div class="row"> 
		<div class="span12"> 
			<h4>Редактировать информацию о книге</h4>
			<?=Form::open('admin/adminbooks/edit/'.$id, array ('enctype'=>'multipart/form-data')) ?>
			   <!--	<legend>Редактировать информацию о книге</legend> -->
					<?if($errors):?>
