...
<!--[if !lte IE 6]><!-->
	...
	<script src="<?=base_url();?>js/jquery.easing-1.3.min.js"></script>
	<script src="<?=base_url();?>js/jquery.fancybox.pack.js"></script>
	<script src="<?=base_url();?>js/jquery.smartStartSlider.min.js"></script>
	<script src="<?=base_url();?>js/jquery.jcarousel.min.js"></script>
	<script src="<?=base_url();?>js/jquery.cycle.all.min.js"></script>
	<script src="<?=base_url();?>js/jquery.isotope.min.js"></script>
	<script src="<?=base_url();?>js/audioplayerv1.min.js"></script>
	<!-- Çהוסü google map-->
